...
const svg=`<svg id="mapa-auren" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1591.67 916.28"><g id="vale-de-ardan"><path d="M0 0h20v20z"/></g><g id="divisoes-internas"/><path id="contorno-geral" d="M0 0h20v20z"/></svg>`
afterEach(()=>{cleanup();vi.restoreAllMocks()})

describe('mapa de Auren',()=>{
  it('carrega os dois arquivos registrados',()=>{expect(existsSync(resolve('public/assets/maps/mapa-realista.png'))).toBe(true);expect(existsSync(resolve('public/assets/maps/mapa-auren.svg'))).toBe(true);expect(mapRegistry.auren.viewBox).toBe('0 0 1591.67 916.28')})
