...
describe('Compêndio',()=>{
 ...
 it('usa o logo como retorno acessível para a página inicial',()=>{render(<MemoryRouter><AppShell/></MemoryRouter>);expect(screen.getByRole('link',{name:'Voltar para a página inicial'})).toHaveAttribute('href','/campanha')})
})
